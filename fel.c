...
{
	soc_info_t *soc_info = dev->soc_info;
	uint32_t arm_code[29], musb_power, new_val, val;
	uint32_t state_ptr_addr;

	if (!soc_info->usb_musb_base || !soc_info->fel_endpoint_state_ptr_addr)
		return false;
	...
	state_ptr_addr = soc_info->fel_endpoint_state_ptr_addr;
	/*
	 ...
	 */
	arm_code[0] = htole32(0xe59f0060); /* ldr  r0, [state_ptr]    */
	arm_code[1] = htole32(0xe3500000); /* cmp  r0, #0             */
	arm_code[2] = htole32(0x0a000010); /* beq  power              */
	arm_code[3] = htole32(0xe5900000); /* ldr  r0, [r0]           */
	arm_code[4] = htole32(0xe3500000); /* cmp  r0, #0             */
	arm_code[5] = htole32(0x0a00000d); /* beq  power              */
	arm_code[6] = htole32(0xe5900024); /* ldr  r0, [r0, #0x24]    */
	arm_code[7] = htole32(0xe3500000); /* cmp  r0, #0             */
	arm_code[8] = htole32(0x0a00000a); /* beq  power              */
	arm_code[9] = htole32(0xe2800010); /* add  r0, r0, #16        */
	arm_code[10] = htole32(0xe3a05002); /* mov  r5, #2             */
	arm_code[11] = htole32(0xe3a04c02); /* mov  r4, #512           */
	arm_code[12] = htole32(0xe5901000); /* ldr  r1, [r0]           */
	arm_code[13] = htole32(0xe3510000); /* cmp  r1, #0             */
	arm_code[14] = htole32(0x0a000001); /* beq  ep_next            */
	arm_code[15] = htole32(0xe5804008); /* str  r4, [r0, #8]       */
	arm_code[16] = htole32(0xe5814004); /* str  r4, [r1, #4]       */
	arm_code[17] = htole32(0xe2800010); /* add  r0, r0, #16        */
	arm_code[18] = htole32(0xe2555001); /* subs r5, r5, #1         */
	arm_code[19] = htole32(0x1afffff7); /* bne  ep_loop            */
	arm_code[20] = htole32(0xe59f0014); /* ldr  r0, [musb_power]   */
	arm_code[21] = htole32(0xe59f1014); /* ldr  r1, [new_val]      */
	arm_code[22] = htole32(0xe5801000); /* str  r1, [r0]           */
	arm_code[23] = htole32(0xf57ff04f); /* dsb  sy                 */
	arm_code[24] = htole32(0xf57ff06f); /* isb  sy                 */
	arm_code[25] = htole32(0xe12fff1e); /* bx   lr                 */
	arm_code[26] = htole32(state_ptr_addr);
	arm_code[27] = htole32(musb_power);
	arm_code[28] = htole32(new_val);
