	...
	0x000002ec, /*        4:    .word      0x000002ec                   */
	/* <install_mmu_remap>: */
	0xe28f0fb7, /*        8:    add        r0, pc, #732                 */
	...
	0xe92d43f0, /*      180:    push       {r4, r5, r6, r7, r8, r9, lr} */
	...
	0xe59f714c, /*      1ac:    ldr        r7, [pc, #332]               */
	0xe1500007, /*      1b0:    cmp        r0, r7                       */
	0x81a00007, /*      1b4:    movhi      r0, r7                       */
	0xe3530c02, /*      1b8:    cmp        r3, #512                     */
	0x1a00003e, /*      1bc:    bne        2bc <copy_pio>               */
	0xe1816000, /*      1c0:    orr        r6, r1, r0                   */
	0xe3160003, /*      1c4:    tst        r6, #3                       */
	0x1a00003b, /*      1c8:    bne        2bc <copy_pio>               */
	0xe59f6128, /*      1cc:    ldr        r6, [pc, #296]               */
	0xe5d68042, /*      1d0:    ldrb       r8, [r6, #66]                */
	0xe5d69043, /*      1d4:    ldrb       r9, [r6, #67]                */
	0xe1a07088, /*      1d8:    lsl        r7, r8, #1                   */
	0xe2477001, /*      1dc:    sub        r7, r7, #1                   */
	0xe1a07087, /*      1e0:    lsl        r7, r7, #1                   */
	0xe3877001, /*      1e4:    orr        r7, r7, #1                   */
	0xe5c67043, /*      1e8:    strb       r7, [r6, #67]                */
	0xe5d67087, /*      1ec:    ldrb       r7, [r6, #135]               */
	0xe3877008, /*      1f0:    orr        r7, r7, #8                   */
	0xe5c67087, /*      1f4:    strb       r7, [r6, #135]               */
	0xe3877080, /*      1f8:    orr        r7, r7, #128                 */
	0xe3877020, /*      1fc:    orr        r7, r7, #32                  */
	0xe5c67087, /*      200:    strb       r7, [r6, #135]               */
	0xe3c77008, /*      204:    bic        r7, r7, #8                   */
	0xe5c67087, /*      208:    strb       r7, [r6, #135]               */
	0xe3877008, /*      20c:    orr        r7, r7, #8                   */
	0xe5c67087, /*      210:    strb       r7, [r6, #135]               */
	0xe3a07001, /*      214:    mov        r7, #1                       */
	0xe5867504, /*      218:    str        r7, [r6, #1284]              */
	0xe5867500, /*      21c:    str        r7, [r6, #1280]              */
	0xe5861544, /*      220:    str        r1, [r6, #1348]              */
	0xe5860548, /*      224:    str        r0, [r6, #1352]              */
	0xe59f70b4, /*      228:    ldr        r7, [pc, #180]               */
	0xe1877008, /*      22c:    orr        r7, r7, r8                   */
	0xe5867540, /*      230:    str        r7, [r6, #1344]              */
	0xe59f70ac, /*      234:    ldr        r7, [pc, #172]               */
	/* <copy_dma_wait>: */
	0xe5968504, /*      238:    ldr        r8, [r6, #1284]              */
	0xe3180001, /*      23c:    tst        r8, #1                       */
	0x1a00000e, /*      240:    bne        280 <copy_dma_done>          */
	0xe596854c, /*      244:    ldr        r8, [r6, #1356]              */
	0xe3580000, /*      248:    cmp        r8, #0                       */
	0x0a00000b, /*      24c:    beq        280 <copy_dma_done>          */
	0xe2577001, /*      250:    subs       r7, r7, #1                   */
	0x1afffff7, /*      254:    bne        238 <copy_dma_wait>          */
	0xe5967540, /*      258:    ldr        r7, [r6, #1344]              */
	0xe3c77102, /*      25c:    bic        r7, r7, #-2147483648         */
	0xe5867540, /*      260:    str        r7, [r6, #1344]              */
	0xe5d67087, /*      264:    ldrb       r7, [r6, #135]               */
	0xe3c770a8, /*      268:    bic        r7, r7, #168                 */
	0xe5c67087, /*      26c:    strb       r7, [r6, #135]               */
	0xe5c69043, /*      270:    strb       r9, [r6, #67]                */
	0xe1580000, /*      274:    cmp        r8, r0                       */
	0x1a00000d, /*      278:    bne        2b4 <copy_dma_failed>        */
	0xea00000e, /*      27c:    b          2bc <copy_pio>               */
	/* <copy_dma_done>: */
	0xe5967540, /*      280:    ldr        r7, [r6, #1344]              */
	0xe3c77102, /*      284:    bic        r7, r7, #-2147483648         */
	0xe5867540, /*      288:    str        r7, [r6, #1344]              */
	0xe3a07001, /*      28c:    mov        r7, #1                       */
	0xe5867504, /*      290:    str        r7, [r6, #1284]              */
	0xe5d67087, /*      294:    ldrb       r7, [r6, #135]               */
	0xe3c770a8, /*      298:    bic        r7, r7, #168                 */
	0xe5c67087, /*      29c:    strb       r7, [r6, #135]               */
	0xe5c69043, /*      2a0:    strb       r9, [r6, #67]                */
	0xe5957010, /*      2a4:    ldr        r7, [r5, #16]                */
	0xe0877000, /*      2a8:    add        r7, r7, r0                   */
	0xe5857010, /*      2ac:    str        r7, [r5, #16]                */
	0xea00000a, /*      2b0:    b          2e0 <copy_done>              */
	/* <copy_dma_failed>: */
	0xe3a00000, /*      2b4:    mov        r0, #0                       */
	0xea000008, /*      2b8:    b          2e0 <copy_done>              */
	/* <copy_pio>: */
	0xe1a00003, /*      2bc:    mov        r0, r3                       */
	0xe5957010, /*      2c0:    ldr        r7, [r5, #16]                */
	0xe0877003, /*      2c4:    add        r7, r7, r3                   */
	0xe5857010, /*      2c8:    str        r7, [r5, #16]                */
	/* <copy_loop>: */
	0xe2533001, /*      2cc:    subs       r3, r3, #1                   */
	0x4a000002, /*      2d0:    bmi        2e0 <copy_done>              */
	0xe5d47000, /*      2d4:    ldrb       r7, [r4]                     */
	0xe4c17001, /*      2d8:    strb       r7, [r1], #1                 */
	0xeafffffa, /*      2dc:    b          2cc <copy_loop>              */
	/* <copy_done>: */
	0xe8bd83f0, /*      2e0:    pop        {r4, r5, r6, r7, r8, r9, pc} */
	/* <usb_dma_chan_cfg_rx_512>: */
	0x82000010, /*      2e4:    .word      0x82000010                   */
	/* <dma_timeout>: */
	0x10000000, /*      2e8:    .word      0x10000000                   */
	/* <fel_rx_dma_params>: */
	0x00000000, /*      2ec:    .word      0x00000000                   */
	/* <l2_tt_addr>: */
	0x00000000, /*      2f0:    .word      0x00000000                   */
	/* <brom_hook_addr>: */
	0x00000000, /*      2f4:    .word      0x00000000                   */
	/* <brom_hook_page_shadow>: */
	0x00000000, /*      2f8:    .word      0x00000000                   */
	/* <usb_base>: */
	0x00000000, /*      2fc:    .word      0x00000000                   */
	/* <dma_max_len>: */
	0x00000000, /*      300:    .word      0x00000000                   */
