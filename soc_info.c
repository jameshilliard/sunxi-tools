...
static const secure_svc_smc_info ncat_gicv2_secure_svc_smc = {
...
soc_info_t soc_info_table[] = {
	{
		...
		.ver_reg      = 0x03000024,
		/* EFUSE_LCJS: secure boot sets bit 11. */
		.smc_workaround_probe_addr = 0x03006248,
		.secure_boot_status_offset = 0xa0,
		.smc_workaround = SMC_WORKAROUND_SECURE_SVC,
		.secure_svc_smc = &ncat_gicv2_secure_svc_smc,
		.watchdog     = &wd_h6_compat,
	},{
